    ...
    <div className="group m-2">
      <div className="card bg-base-100 w-96 shadow-xl hover:shadow-2xl transition-all duration-500 ease-in-out transform hover:-translate-y-2 overflow-hidden border border-gray-200 dark:border-gray-700">
        ...
        <div className="card-body p-6 space-y-4">
          <h2 className="card-title text-2xl font-bold bg-linear-to-r from-primary to-secondary bg-clip-text text-transparent group-hover:scale-105 transition-transform duration-300">
            {blog.name}
          </h2>
          ...
          <div className="flex items-center gap-3 pt-3 border-t border-gray-200 dark:border-gray-700">
            ...
            <div className="mark-read">
              <button className="btn btn-primary btn-sm group/btn relative overflow-hidden">
                ...
                <span className="absolute inset-0 bg-linear-to-r from-secondary to-accent transform scale-x-0 group-hover/btn:scale-x-100 transition-transform duration-500 origin-left"></span>
              </button>
            </div>
          </div>
        </div>
